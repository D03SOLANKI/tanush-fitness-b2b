...
const MainContent: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-[#0F1926] text-[#E8E8E8] flex flex-col justify-between selection:bg-[#E8E8E8] selection:text-[#0F1926] font-sans antialiased pb-24 sm:pb-28">
