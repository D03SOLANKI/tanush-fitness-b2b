    ...
    <AnimatePresence>
      {isOpen && (
        ...
        >
          ...
          {/* ========================================================================= */}
          <div className="bg-[#26452D] text-white py-3 sm:py-4 px-6 sm:px-12 flex items-center justify-between border-b border-white/10 z-20 shrink-0">
            <div>
              <a
                href="mailto:Info@tanushfitness.com"
                className="font-mono text-xs sm:text-sm text-slate-300 hover:text-white underline tracking-wider"
              >
          ...
          <div className="py-4 sm:py-5 px-6 sm:px-12 z-20 shrink-0">
            <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-4">
              ...
              <div className="hidden lg:flex items-center gap-1.5 bg-[#0D1811]/90 backdrop-blur-md border border-white/10 p-1.5 rounded-full font-mono text-xs uppercase tracking-wider text-slate-300 shadow-2xl">
                <button
                  type="button"
                  onClick={() => handleNav('home')}
