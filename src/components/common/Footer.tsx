...
export const Footer: React.FC = () => {
  ...
  return (
    <footer className="bg-[#0C1015] text-[#F2F0EC] border-t border-[#2A2A2B] relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <div className="flex flex-wrap items-center gap-3 shrink-0">
            ...
            <a
              ...
              className="px-5 py-3 rounded-full border border-[#2A2A2B] hover:border-[#D0CFCA] text-[#F2F0EC] text-xs font-mono uppercase tracking-wider transition hover:bg-[#2A2A2B]/40 flex items-center gap-2"
            >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div className="space-y-6">
            ...
            <div className="flex flex-wrap items-center gap-3 text-xs font-mono text-[#D0CFCA] pt-2">
              <span className="flex items-center gap-1.5 text-[#F2F0EC] font-bold">
          ...
          <div className="space-y-4 font-sans text-sm">
            ...
            <ul className="space-y-2.5 text-xs text-[#D0CFCA]">
              <li>
                <button onClick={() => { navigateTo('equipment'); scrollToTop(); }} className="hover:text-[#F2F0EC] transition-colors text-left cursor-pointer flex items-center gap-1.5">
              ...
              <li>
                <button onClick={() => { navigateTo('services'); scrollToTop(); }} className="hover:text-[#F2F0EC] transition-colors text-left cursor-pointer flex items-center gap-1.5">
          ...
          <div className="space-y-4 font-sans text-sm">
            ...
            <ul className="space-y-2.5 text-xs text-[#D0CFCA]">
              <li>
                <button onClick={() => { navigateTo('services'); scrollToTop(); }} className="hover:text-[#F2F0EC] transition-colors text-left cursor-pointer">
              ...
              <li>
                <button onClick={() => { navigateTo('manpower'); scrollToTop(); }} className="hover:text-[#F2F0EC] transition-colors text-left cursor-pointer">
                  7-Division Certified Master Staffing
                </button>
              </li>
              <li>
                <button onClick={() => { navigateTo('about'); scrollToTop(); }} className="hover:text-[#F2F0EC] transition-colors text-left cursor-pointer">
                  Corporate Wellness & Hotel Blueprints
                </button>
              </li>
              <li>
                <button onClick={() => { navigateTo('contact'); scrollToTop(); }} className="hover:text-[#F2F0EC] transition-colors text-left cursor-pointer">
          ...
          <div className="space-y-4 font-sans text-sm">
            ...
            <div className="space-y-3 text-[#D0CFCA] text-xs">
              ...
              <div className="flex items-center gap-2.5">
                ...
                <a href="tel:+918160918894" className="hover:text-[#F2F0EC] transition font-mono text-[#F2F0EC]">
                  +91 81609 18894
                </a>
              </div>
              <div className="flex items-center gap-2.5">
                <Mail className="w-4 h-4 text-[#D0CFCA] shrink-0" />
                <a href="mailto:Info@tanushfitness.com" className="hover:text-[#F2F0EC] transition font-mono text-[#F2F0EC]">
        ...
        <div className="pt-8 border-t border-[#2A2A2B] flex flex-col sm:flex-row items-center justify-between gap-4 text-xs font-mono text-[#D0CFCA]">
          ...
          <div className="flex items-center gap-5">
            <button
              ...
              className="flex items-center gap-1.5 hover:text-[#F2F0EC] transition-colors cursor-pointer"
            >
              <Lock className="w-3 h-3 text-[#D0CFCA]" />
              <span>Admin Console</span>
            </button>
            <span className="text-[#2A2A2B]">•</span>
            <button onClick={() => { navigateTo('contact'); scrollToTop(); }} className="hover:text-[#F2F0EC] transition-colors cursor-pointer">
              Outfitting Desk
            </button>
            <span className="text-[#2A2A2B]">•</span>
            <button
              onClick={scrollToTop}
              className="p-1.5 rounded-full bg-[#2A2A2B] hover:bg-[#0F1926] hover:text-white transition text-[#F2F0EC] cursor-pointer"
              title="Back to Top"
            >
