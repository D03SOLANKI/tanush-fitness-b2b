      ...
      <div className="bg-[#0D1118] text-white py-3.5 sm:py-4 px-6 sm:px-12 flex items-center justify-between border-b border-white/10 shrink-0 z-20">
        <div>
          <a
            ...
            className="font-mono text-xs sm:text-sm text-white/80 hover:text-white underline tracking-wider transition-colors"
          >
      ...
      <div className="relative flex-1 max-w-7xl mx-auto w-full px-6 sm:px-12 my-auto flex items-center overflow-hidden">
        ...
        <div className="space-y-4 sm:space-y-5 md:space-y-6 z-10 w-full max-w-3xl">
          {DIRECTORY_ITEMS.map((item) => (
            ...
            >
              <span className="font-mono text-xs sm:text-sm md:text-base text-[#A8A090] group-hover:text-white font-bold tracking-widest shrink-0 transition-colors">
                {item.num}
              </span>

              <div className="relative flex-1">
                <span className="font-satoshi text-2xl sm:text-3xl md:text-4xl lg:text-[40px] font-black uppercase text-[#F0EBE3] group-hover:text-white group-hover:translate-x-3 transition-all duration-300 block leading-tight">
                  {item.title}
                </span>
                <div className="h-[1px] bg-white/10 w-full mt-2 group-hover:bg-white transition-colors duration-300" />
              </div>
            </div>
          ))}
        </div>
