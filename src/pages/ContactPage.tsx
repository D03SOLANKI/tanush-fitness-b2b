...
export const ContactPage: React.FC = () => {
  return (
    <main className="min-h-screen bg-[#0F1926] text-[#F2F0EC] overflow-hidden pt-8 pb-0">
      <SEO
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 border-b border-[#2A2A2B] pb-8">
          ...
          <div className="flex flex-wrap items-center gap-4">
            <a
              ...
              className="bg-[#0C1015] border border-[#2A2A2B] hover:border-[#D0CFCA] text-[#F2F0EC] px-5 py-2.5 rounded-full font-satoshi text-xs uppercase tracking-wider flex items-center gap-2 transition cursor-pointer shadow-md"
            >
              <MessageSquare className="w-3.5 h-3.5 text-[#F2F0EC]" />
      ...
      {/* Showroom & Logistics Hubs (#F2F0EC LIGHT CARDS) */}
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 border-t border-[#2A2A2B]">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="bg-[#F2F0EC] text-[#0F1926] border border-[#2A2A2B]/10 rounded-2xl p-8 space-y-3 group hover:border-[#0F1926] transition-all duration-300 shadow-2xl hover:-translate-y-1">
